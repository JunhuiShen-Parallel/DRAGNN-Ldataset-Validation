...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='Ldataset', help='Choose a dataset. [Fdataset/Cdataset/LRSSL/Ldataset]')
    ...
    parser.add_argument('--disease_knn_number', type=int, default=9)
    parser.add_argument('--drug_knn_number', type=int, default=3)
